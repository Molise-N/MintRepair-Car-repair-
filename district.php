                ...
                <ul class="list-unstyled templatemo-accordion">
                    ...
                    <li class="pb-3">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=maseru']?>">Maseru</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Berea']?>">Bereea</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=leribe']?>">Leribe</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Botha bothe']?>">Botha Bothe</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Mokhotlong']?>">Mokhotlong</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Thaba Tseka']?>">Thaba Tseka</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Qacha']?>">Qacha's Nek</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Mohale']?>">Quthing</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=maseru']?>">Mohale's Hoek</a></li>
                            <li><a class="text-decoration-none" href="district.php?district=<?=$property['District=Mafeteng']?>">Mafeteng</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
